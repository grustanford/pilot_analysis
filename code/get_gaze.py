...
def get_gaze_angle_relative_to_gravity(world_gaze):
    """
    This function takes in a list of 3d vectors in the world frame where [x, y, z] == [0, 1, 0] is the direction of gravity and returns a list of angles between the gaze vector and the gravity vector
    :param world_gaze: a list of 3d vectors in the world frame where [x, y, z] == [0, 1, 0] is the direction of gravity
...
def get_world_gaze(root_dir):
    """
    This function takes in a root directory of the dataset and returns a list of 3d vectors in the world frame where [x, y, z] == [0, 1, 0] is the direction of gravity
    :param root_dir: root directory of the dataset
    :return: a list of 3d vectors in the world frame where [x, y, z] == [0, 1, 0] is the direction of gravity
    """
    ...
    # need to grab from gaze.csv
    gaze_points = pd.read_csv(root_dir + 'gaze.csv', usecols=['gaze x [px]', 'gaze y [px]']).values
    gaze_ts = pd.read_csv(root_dir + 'gaze.csv', usecols=['timestamp [ns]']).values.reshape(-1)
    ...
    world_gaze = [] # this will be a list of 3d vectors in the world frame where [x, y, z] == [0, 1, 0] is the direction of gravity
...
def main():
    ...
    world_gaze = get_world_gaze(root_dir)
